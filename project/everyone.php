...
<body>
   ...
   <div id="top">
      <div> Master Of Computer Application &nbsp;&nbsp;&nbsp; <b>language:</b>
            <select name="#">
...
<div id="admin">
        ...
        <div id="lmain">
                <a href="#" title="logo" ><img src="picture/1OGO.jpg" /></a>
                <div id="leftmanu">
                	<div >
              ...
              <!--      
                ...
                -->
                     <div>
                    	<a href="everyone.php?tag=About" class="customer" title="Shift+9">&nbsp;About</a>
                    </div>
                    
                     <div>
                    	<a href="everyone.php?tag=Contact" class="customer" title="Shift+Ctrl+C">&nbsp;Contact </a>
                    </div>
...
-->                    </ul>
            ...
            -->    <li id="li_menu"><a href="">AboutUs</a>
                    ...
                    <ul>
                        <li id="li_submenu"><a href="everyone.php?tag=About" class="stocks">Deptment</a></li>
                        <li id="li_submenu"><a href="everyone.php?tag=About1" class="sales">admin</a></li>
                ...
                <li id="li_menu"><a href="">Contact</a>
                	...
                	<ul>
                    	 <li id="li_submenu"><a href="everyone.php?tag=About1" class="customer">Contact Admin</a></li>
                        <li id="li_submenu"><a href="everyone.php?tag=Contact" class="order">Department Contact</a></li>
